...
pacstrap /mnt base base-devel linux linux-firmware networkmanager vim man-db man-pages zsh-syntax-highlighting zsh-completions texinfo intel-ucode grub efibootmgr xorg-server alacritty ranger lightdm lightdm-gtk-greeter nvidia neofetch git nvidia-settings os-prober zsh zip unzip
