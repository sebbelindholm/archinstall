...
cd ..
rm -rf yay
yay -S --noconfirm google-chrome nerd-fonts-complete rofi-wifi-menu-git visual-studio-code-bin
mkdir github
mkdir Download
mkdir Pictures
mkdir Documents
